...
slices are mujch more commonn; arrays are useful in some scenarios.
...
func main() {
	...
	We can set a value at an index using the arrat[index] = value syntax,
	...
	Use this sintax to declare and initialize an array in one line.
