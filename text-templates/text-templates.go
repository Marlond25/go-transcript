...
Go offers built-in support for creating dynamic content of showing customized output to the user with the text/template package. A sibling package named html/template provides the same API but has additional security features and should be used for generating HTML.
...
func main() {
	...
	Helper functions we'll use below.
