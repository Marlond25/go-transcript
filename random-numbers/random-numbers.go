...
func main() {
	...
	// The default number generator is deterministic, so it'll product the same sequence of numbers each time by default. To produce varying sequences, give it a seed that changes. Note that this is not safe to use for random numbers you intend to be secret; use crypto/rand for those.
