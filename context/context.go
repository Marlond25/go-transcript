...
// In the previous example we looked at setting up a simple HTTP server. HTTP servers are useful for demostrating the usage of context.Context for controlling cancellation. A Context carries deadlines, cancellation signals, and other request-scoped values across API boundaries and goroutines.
...
func hello(w http.ResponseWriter, req *http.Request) {
	...
	case <-ctx.Done():
		...
		// The context's Err() method returns and error that explains why the Done() channel was closed.
