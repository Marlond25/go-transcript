...
func main() {
	...
	// Basic flag declarations are available for string, integer, and boolean option. Here we declare a string flag word with a default value "foo" and a short description. This flag.String function returns a string pointer (not a string value); we'll see how to use this pointer below.
