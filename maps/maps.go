...
Printing a map with e.g. fmt.Println will show all its key/value pairs.
...
The buildin len returns the number of key/value pairs when called on a map.
...
Note that maps appear in the form map[k:v k:v] when printed with
fmt.Println.
