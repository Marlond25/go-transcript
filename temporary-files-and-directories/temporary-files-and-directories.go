...
func main() {
	...
	// Clean up the file after we're done. the OS id likely to clean up temporary files by itself after some time, but it's good practice to do this explicitly.
