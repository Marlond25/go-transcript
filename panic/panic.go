...
Running this program will cause it to panic, print an error message the rest of the code. If you'd like to see the program try to create a temp file, comment out the first panic.
