...
func main() {
	...
	// To get query params in a string of k=v format, use RawQuery. You can also parse query params into a map. The parsed query params are from strings to slices of strings, so index into [0] if you only want the first value.
